...
class _cell_(object):
    def __init__(
        ...
        self.__Patternsrtn=[]
        self.__RnA=[];self.__Wij_neurons=[];self.__epoc=int(epoc)
        self.__adj_0=int(adj0);self.__adj_1=int(adj1);self.__corr=float(corr)
        self.__limit=float(limit);self.__denLayer_0=int(denLayer0)
        self.__denLayer_1_0=int(denLayer1_0);self.__denLayer_1_1=int(denLayer1_1)
        self.__denLayer_2=int(denLayer2);self.__dinWij=int(dimWij)
        self.__neurons=int(neurons);self.__id_ = int(id_)
